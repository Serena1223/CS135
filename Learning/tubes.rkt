...
;; Examples:
(check-expect (valid-game? 3 3 '(yellow blue red)) true)
(check-expect (valid-game? 3 2 '(yellow blue red)) false)
(check-expect (valid-game? 3 4 '(yellow blue red red)) false)
(check-expect (valid-game? 3 3 '()) true)
...
(check-expect (finished-game? game1-next) false)
...
;; Part G
;; Examples:
(check-expect (all-equiv? (list game1-start) (list game1-start)) true)
(check-expect (all-equiv? empty (list game1-start)) false)
(check-expect (all-equiv? (list game1-start game1-next) (list game1-start game2-start)) false)
(check-expect (all-equiv? (list biggame biggame2)
                          (list biggame2 biggame)) true)
